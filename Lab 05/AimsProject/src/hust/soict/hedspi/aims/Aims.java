        ...
        if (media != null) {
            if (media instanceof DigitalVideoDisc || media instanceof CompactDisc) {
                try {
                    ...
                    System.err.println("An error occurred while playing media:");
                    System.err.println("Message: " + e.getMessage());
                    e.printStackTrace();

                    // Hiển thị hộp thoại lỗi
                    JOptionPane.showMessageDialog(null,  "Error: " + e.getMessage(),  "Playback Error",JOptionPane.ERROR_MESSAGE);
                }
            } else {
