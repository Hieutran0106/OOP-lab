...
public class CartController {
    ...
    void btnViewStorePressed(ActionEvent event) {
        try {
            ...
            alert.setTitle("Loi chuyen man hinh");
            alert.setHeaderText("khong the tai man hinh cua hang.");
            alert.setContentText("loi: " + e.getMessage());
            alert.showAndWait();
        }
    }
    ...
    void btnRemovePressed(ActionEvent event) {
        ...
        if (selectedMedia != null) {
            ...
            alert.setHeaderText(null);
            alert.setContentText("Chon 1 muc de xoa");
            alert.showAndWait();
        }
    }
